	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				//float3 Color = (( _MatCapSwitch )?( temp_cast_7 ):( float4( tex2D( _DiffuseMap, uv_DiffuseMap ).rgb , 0.0 ) )).xyz * float3(.73,.16,0);
...
ASEEND*/
//CHKSM=515B4098BDB6326243F417BFDA477CB75E061043